                ...
                ?>
                  <article class="blog_listing_wrapper">
                    <figure class="post_title">
                      <h2> <a href="<?php echo base_url() . 'Artikel/' . $post_slug; ?>"> <span style="font-size: 28px;"> <?php echo $post_tglpost ?> </span> <?php echo $post_judul ?> </h2> </a>
                    </figure>
                    ...
                    <figure class="post_description">
                      <p> <?php echo limit_words($post_isi, 30) . '...'; ?></p>
                    </figure>
