          ...
          <!-- Carousel -->
                        ...
                        <span class="border-line m-bottom" style="margin-top: 5px;margin-left: -10px;"></span>
                          ...
                          <?php foreach($tautan->result_array() as $row):
                            ...
                            ?>  
                            <li><a href="<?php echo $link; ?>" target="_blank"><img src="<?php echo base_url().'assets/images/'.$gambar?>" style="width: 60px;height:50px;margin-right: 9px;"><?php echo limit_words($judul,1).'...'; ?></a></li>
