                  ...
                  <div class="nav-collapse collapse">
                    ...
                    <ul class="nav" style="width: 100%; margin-top:5px">
                      ...
                      <li class="navv dropdown <?php echo $cek2?>"> <a class="dropdown-toggle"
                          href="<?php echo base_url(). 'Home/profil'?>">Profil<b class="caret"></b> </a>
                        <ul class="dropdown-menu pull-left">
                          <li class="dropdown"><a class="dropdown-toggle" href="#">SMK PPN Sembawa</a>
                            <ul class="dropdown-menu">
                              ...
                              <li><a href="<?php echo base_url().'Profil/struktur_organisasi' ?>">Struktur
                                  Organisasi</a></li>
                            </ul>
                          </li>
                          <li><a href="<?php echo base_url().'Profil/daftar_nama' ?>">Daftar Nama / Alamat Pejabat</a>
                          </li>
                      ...
                      <li class="navv dropdown <?php echo $cek3?>"> <a class="dropdown-toggle" href="#">Program<b
                            class="caret"></b> </a>
                        <ul class="dropdown-menu pull-left">
                      ...
                      <li class="navv dropdown <?php echo $cek4?>"> <a class="dropdown-toggle" href="#">Kinerja<b
                            class="caret"></b> </a>
                        <ul class="dropdown-menu pull-left">
                          <li class="dropdown"><a class="dropdown-toggle-left" href="#">Kinerja</a>
                            <ul class="dropdown-menu">
                              ...
                              <li><a href="<?php echo base_url() ?>Kinerja/realisasi_anggaran">Realisasi Anggaran</a>
                              </li>
                          ...
                          <li><a href="<?php echo base_url().'Kinerja/laporan_tahunan_ppid' ?>">Laporan Tahunan PPID</a>
                          </li>
                          <li><a href="<?php echo base_url().'Kinerja/laporan_masyarakat' ?>">Index Kepuasan
                              Masyarakat</a></li>
                        </ul>
                      </li>
                      ...
                      <li class="navv dropdown <?php echo $cek7?>"> <a class="dropdown-toggle" href="#">Kurikulum<b
                            class="caret"></b> </a>
                        <ul class="dropdown-menu">
                          <li> <a href="<?php echo base_url().'Kurikulum'?>">Kalender Pendidikan</a> </li>
                          <li> <a href="http://dapo.dikdasmen.kemdikbud.go.id/sekolah/964D53F4E9937D2E5327">DAPODIK</a>
                          </li>
                        </ul>
                      </li>

                      <li class="navv dropdown <?php echo $cek8?>"> <a class="dropdown-toggle" href="#">Sarana<b
                            class="caret"></b> </a>
                        <ul class="dropdown-menu">
                      ...
                      <li class="navv dropdown <?php echo $cek9?>"> <a class="dropdown-toggle" href="#">Publikasi<b
                            class="caret"></b> </a>
                        <ul class="dropdown-menu">
                      ...
                      <li class="navv dropdown <?php echo $cek10?>"> <a class="dropdown-toggle" href="#">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a href="<?php echo base_url().'Informasi/informasi_publik_berkala'?>">Informasi Publik
                              Berkala</a></li>
                          <li><a href="<?php echo base_url().'Informasi/informasi_publik_setiap_saat'?>">Informasi
                          ...
                          <li><a href="<?php echo base_url().'Informasi/form_permintaan'?>">Form Permintaan Informasi
                              Publik</a></li>
                          <li><a href="https://kegpertanian.wordpress.com/">Laporan Kegitan</a></li>
                        </ul>
                      </li>

                      <li class="navv dropdown <?php echo $cek11?>"> <a class="dropdown-toggle" href="#">Gallery<b
                            class="caret"></b></a>
                        <ul class="dropdown-menu">
								...
								<figure class="post_description">
									...
									<div class="alert alert-success">
										...
										<a class="btn btn-sm"
											...
											title="Good"><img src="<?php echo base_url().'assets/img/heart.png'?>"></a>
										<a class="btn btn-sm"
											href="<?php echo base_url().'Artikel/like/'.$b['tulisan_slug']?>"
											title="Like"><img src="<?php echo base_url().'assets/img/like.png'?>"></a>
										<a class="btn btn-sm"
										...
										<a class="btn btn-sm"
											...
											title="Genius"><img src="<?php echo base_url().'assets/img/star.png'?>"></a>
									</div>
									<?php endif;?>
								</figure>
							</article>
						...
						<section class="span3 sidebar">
							...
							<article class="widget">
								<form id="search_form" action="<?php echo base_url().'Informasi/search'?>"
									method="post">
									<input type="text" class="text" placeholder="Cari Artikel Disini ..." name="xfilter"
										required>
