            ...
            <div class="col-md-12">
              <section class="page_content">
                <?php foreach ($latest_header->result() as $row) : ?>
                  <center>
                    <figure class="span4"><img class="team-img f-width-img" src="<?php echo base_url() . 'assets/images/header/' . $row->link; ?>" style="max-height: 282px;width: 75%;" alt="Header <?php echo $row->tanggal ?>" /> </a> </figure>
                    ...
                    <center>
                      <div class="col-md-12">
                        <div class="form-group">
                          <center>
                            <h5>Updated: <?= $row->tanggal ?> | <?= $row->oleh ?></h5>
                          </center>
                        </div>
                        <div class="form-group">
        ...
        <div class="row">
            ...
            <?php foreach ($history_header->result() as $row) : ?>
              <div class="col-md-4">
                <section class="page_content">
                  ...
                  <center>
                    <h6>Updated: <?= $row->tanggal ?> | <?= $row->oleh ?></h6>
                  </center>
                  <br>
          ...
          <?php else : ?>
            <div class="col-md-12">
              <section class="page_content">
                <center>
                  <h5>Tidak ada history header</h5>
                </center>
              </section>
            </div>
          <?php endif; ?>
