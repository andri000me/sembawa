                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xlink" class="form-control" id="inputUserName" placeholder="Link Embed" required>
                                            <span>Isi ini dengan link embed dari youtube</span>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">       
                                <input type="hidden" name="kode" value="<?php echo $video_id;?>"/> 
                                  <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">nama</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnama" class="form-control" id="inputUserName" placeholder="Nama" value="<?php echo $video_judul;?>" required>
                                        </div>
                                    </div>
                                  <div class="form-group">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $video_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">       
							       <input type="hidden" name="kode" value="<?php echo $video_id;?>"/>
                     <input type="hidden" value="<?php echo $video_id;?>" name="pengguna">
                            <p>Apakah Anda yakin mau menghapus Posting <b><?php echo $video_link;?></b> ?</p>
