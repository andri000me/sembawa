...
<div class="modal fade" id="tambahFile" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="<?php echo base_url()?>Admin/Program/simpan_file/<?=$kode?>" method="post" enctype="multipart/form-data">
  ...
  <div class="modal fade" id="ModalHapus<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url()?>Admin/Program/hapus_file/<?=$kode?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
