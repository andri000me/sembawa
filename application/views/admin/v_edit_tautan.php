  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        $b=$data->row_array();
    ?>
		<form action="<?php echo base_url().'Admin/Tautan/update_tulisan'?>" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label>Link</label>
                <input type="text" name="xlink" style="width:100%;" value="<?php echo $b['tulisan_link'] ?>" required>
              </div>
