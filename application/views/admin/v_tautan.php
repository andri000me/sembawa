                  ...
                  ?>
                    <tr>
                      ...
                      <td style="text-align:right; width: 58px; ">
                        <a class="btn" href="<?php echo base_url() . 'Admin/Tautan/get_edit/' . $tulisan_id; ?>"><span class="fa fa-pencil"></span></a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Hapus Tautan</h4>
        </div>
        <form class="form-horizontal" action="<?php echo base_url() . 'Admin/Tautan/hapus_tulisan' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <p>Apakah Anda yakin mau menghapus tautan <b><?php echo $tulisan_judul; ?></b> ?</p>
